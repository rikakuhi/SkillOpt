...
delegated to an :class:`~reflact.envs.base.EnvAdapter` instance.
"""
...
from reflact.evaluation.gate import evaluate_gate
from reflact.gradient.aggregate import merge_patches
from reflact.optimizer.meta_reflect import build_epoch_history, run_meta_reflect
from reflact.optimizer.meta_skill import run_meta_skill
from reflact.optimizer.clip import rank_and_select
from reflact.optimizer.lr_autonomous import decide_autonomous_learning_rate
from reflact.optimizer.rewrite import rewrite_skill_from_suggestions
from reflact.optimizer.scheduler import build_scheduler
from reflact.optimizer.skill import apply_patch_with_report
from reflact.optimizer.slow_update import (
...
from reflact.utils import compute_score, skill_hash
...
def _normalise_patches(
    ...
    Each element is expected to conform to :class:`~reflact.types.RawPatch`.
    """
