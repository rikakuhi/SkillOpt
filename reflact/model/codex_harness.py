...
from reflact.model.backend_config import (
...
def prepare_workspace(
    *,
    ...
    os.makedirs(os.path.join(work_dir, ".agents", "skills", "reflact-student"), exist_ok=True)

    skill_path = os.path.join(work_dir, ".agents", "skills", "reflact-student", "SKILL.md")
...
def _exec_prompt(prompt: str, *, allow_file_edits: bool = False) -> str:
    ...
    return (
        ...
        ".agents/skills/reflact-student/SKILL.md before answering. "
...
def _retry_prompt(prompt: str, attempt: int) -> str:
    ...
    return (
        ...
        ".agents/skills/reflact-student/SKILL.md. If ATTACHMENTS.md exists, use the listed files. "
...
def _normalize_student_exec_prompt(prompt: str) -> str:
    ...
    replacements = {
        "Use the `reflact-student` skill available in this workspace.": (
            "Read `.agents/skills/reflact-student/SKILL.md` directly; do not call a Skill tool."
        ),
        "- Use the local `reflact-student` skill before writing code.": (
            "- Read `.agents/skills/reflact-student/SKILL.md` before writing code; do not call a Skill tool."
        ),
    }
