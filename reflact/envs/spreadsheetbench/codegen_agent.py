...
from reflact.model.azure_openai import (
    get_reasoning_effort,
    get_student_client,
    _needs_responses_api,
    tracker,
)
from reflact.model import get_codex_exec_config, get_student_backend, is_student_exec_backend
...
from reflact.envs.spreadsheetbench.executor import run_generated_code
            ...
            if not code.strip():
                ...
                if ok:
                    if gold_path and answer_position:
                        from reflact.envs.spreadsheetbench.rollout import _auto_verify_output
